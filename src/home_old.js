    ...
    <div className='homePage'>
      <div className="container-fluid bg-white">
        <div className="container">
          <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-2">
            <Link href="/"
              className="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-success text-decoration-none fs-4 fw-bold">Company Name</Link>

            <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
              <li><Link className="nav-link px-2 link-primary fw-bold">Home</Link></li>
              <li><Link className="nav-link px-2 link-dark">Features</Link></li>
              <li><Link className="nav-link px-2 link-dark">Pricing</Link></li>
            ...
            <div className="col-md-3 text-end">
              <button type="button"
                className="btn btn-sm btn-outline-primary me-2">Login</button>
              <button type="button"
                className="btn btn-sm btn-primary">Sign-up</button>
            </div>
          </header>
        </div>
      </div>
      <div className="container pt-1">
        <div className="alert alert-info alert-dismissible d-flex flex-row justify-content-between align-items-center p-1 mb-0">
          <span className="badge bg-primary text-white">Trending:</span>
          <p className="text-truncate flex-grow-1 mb-0 mx-3">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
          <button className="btn-close small p-1 me-1 position-relative"
            type="button"
        ...
        <div className="row g-4 py-4">
          <div className="col-lg-6">
            <div className="card rounded-3 h-100 card-post"
              style={{backgroundImage:"url('https://images.unsplash.com/photo-1629104300041-331cddce6ec5?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTYzMTc5NjczNw&ixlib=rb-1.2.1&q=85')"}}>
      ...
      <div className="container-fluid bg-white border-top">
        <footer className="container pt-4">
          ...
          <p className="text-muted small mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>

          <p className="py-3 border-top mb-0">
            <Link 
              className="text-muted text-decoration-none">Company Name</Link>
